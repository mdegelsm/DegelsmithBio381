...
\includegraphics[scale=.4]{UVMLogo.jpg}\\ % delete to remove UVM letterhead
...
\begin{tabular}{@{}l}
Sincerely yours,\\
\includegraphics[scale=0.15,width=2in]{Signature.jpg}\\
Maddy Degelsmith\\
Biological Sciences B.S Candidate\\
Spanish B.A Candidate\\
